...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Sidebar_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Sidebar_t qt_meta_stringdata_Sidebar = {
    {
        QT_MOC_LITERAL(0, 7),  // "Sidebar"
        QT_MOC_LITERAL(8, 13),  // "pageRequested"
        QT_MOC_LITERAL(22, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_Sidebar[] = {
...
Q_CONSTINIT const QMetaObject Sidebar::staticMetaObject = { {
    ...
    qt_meta_stringdata_Sidebar.offsetsAndSizes,
...
void Sidebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Sidebar::pageRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Sidebar::pageRequested(int _t1)
{
