...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_LogViewer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_LogViewer_t qt_meta_stringdata_LogViewer = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_LogViewer[] = {
...
Q_CONSTINIT const QMetaObject LogViewer::staticMetaObject = { {
    ...
    qt_meta_stringdata_LogViewer.offsetsAndSizes,
    qt_meta_data_LogViewer,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_LogViewer_t,
        // Q_OBJECT / Q_GADGET
