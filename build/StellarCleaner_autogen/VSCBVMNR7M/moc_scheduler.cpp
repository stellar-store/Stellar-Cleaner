...
Q_CONSTINIT static const qt_meta_stringdata_Scheduler_t qt_meta_stringdata_Scheduler = {
    {
        ...
        QT_MOC_LITERAL(10, 17),  // "scheduledCleanDue"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 7)   // "onTimer"
    },
    "Scheduler",
    "scheduledCleanDue",
    "",
...
void Scheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->scheduledCleanDue(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Scheduler::scheduledCleanDue; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Scheduler::scheduledCleanDue()
{
